...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Demo account bypass - DEMO LOGIN
    if (formData.email === 'demo@yvettin.com' && formData.password === 'demo123') {
      await new Promise((resolve) => setTimeout(resolve, 800));
      setIsLoading(false);
      localStorage.setItem('yvettin-demo-user', JSON.stringify({
        email: 'demo@yvettin.com',
      ...
      toast({
        title: 'Vitajte, Demo Používateľ!',
        description: 'Prihlásené ako demo účet.',
      });
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-neutral-100 p-8">
            <div className="text-center mb-8">
              <h1 className="text-2xl font-semibold text-neutral-900 mb-2">Prihlásenie</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 text-sm">
                <p className="text-amber-800">
                  <strong>Demo účet:</strong> demo@yvettin.com / demo123
                </p>
              </div>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-white px-4 text-neutral-500">alebo pokračujte cez</span>
              </div>
            </div>
